...
def configure_connector():
    ...
    # use following command to view peek inside consumer console      kafka-console-consumer --topic lesson4.sample2.logs --bootstrap-server localhost:9092 --from-beginning
    resp = rest_method(
        KAFKA_CONNECT_URL,
