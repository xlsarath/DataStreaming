...
class ClickEvent:
    ...
    #root@e3788b474b53:/home/workspace# kafka-console-consumer --bootstrap-server localhost:9092 --topic "com.udacity.lesson3.exercise2.clicks"  --from-beginning
    # schema = parse_schema(...)
    schema = parse_schema(
            {
                "type" : "record",
                "name" : "click_event",
                "namespace" : "com.udacity.lesson3.excercise2",
                "fields" : [
