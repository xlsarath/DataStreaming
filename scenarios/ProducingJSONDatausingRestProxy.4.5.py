...
def produce():
    ...
    #       See: https://docs.confluent.io/current/kafka-rest/api.html#post--topics-(string-topic_name)
    resp = requests.post(
        f"{REST_PROXY_URL}/topics/lesson4.solution5.click_events", data=json.dumps(data), headers=headers,  # TODO
    )
...
if __name__ == "__main__":
    main()
"""kafka-console-consumer --bootstrap-server localhost:9092 --topic "lesson4.solution5.click_events" --from-beginning"""